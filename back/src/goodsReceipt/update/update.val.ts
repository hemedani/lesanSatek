...
import { goodsReceipt_pure } from "@model";

export const updateValidator = () => {
  const { createdAt, updatedAt, ...updatePure } = goodsReceipt_pure;
  ...
  return object({
    set: object({
      ...
      receivedById: optional(objectIdValidation),
      receivingUnitId: optional(objectIdValidation),
    }),
