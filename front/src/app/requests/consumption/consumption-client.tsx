...
import { ScrollText, ArrowRight, User, Building2, MessageSquareText, CalendarDays, ClipboardList, FolderTree, Factory } from "lucide-react"
...
const columns: Column<ConsumptionRecord>[] = [
  {
    ...
    label: "کالا",
    render: (item) => (
      <Link href={`/requests/consumption/${item._id}`} className="flex items-center gap-3 min-w-0 max-w-[280px] group">
