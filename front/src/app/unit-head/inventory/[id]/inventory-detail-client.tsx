        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          {movements.length > 0 && (
            <SectionCard
              ...
              badge={
                <Link href="/unit-head/stock-movements" className="inline-flex items-center gap-1.5 text-body-sm text-fog transition-colors hover:text-frost-link">
                  مشاهده همه
              ...
              <div className="space-y-2">
                {movements.map((mv) => {
                  ...
                  return (
                    <Link
                      key={mv._id}
                      href={`/unit-head/stock-movements/${mv._id}`}
        ...
        <div className="space-y-6">
          <SectionCard icon={Zap} title="اقدامات" iconClassName="bg-electric-iris/10 text-electric-iris ring-electric-iris/15">
            <div className="space-y-3">
              ...
              <Link href="/unit-head/consumption" className="block w-full">
                <Button variant="ghost" className="w-full gap-2">
