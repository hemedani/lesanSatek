  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (res.success) {
        ...
        setDeleteOpen(false)
        router.push("/unit-head/stock-movements")
      } else {
        ...
        <CardHeader className="pb-4">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
              {relatedInventoryId && (
                <Link href={`/unit-head/inventory/${relatedInventoryId}`}>
        ...
        <div className="space-y-6">
          <SectionCard icon={Zap} title="اقدامات" iconClassName="bg-electric-iris/10 text-electric-iris ring-electric-iris/15">
            <div className="space-y-3">
              {relatedInventoryId && (
                <Link href={`/unit-head/inventory/${relatedInventoryId}`} className="block w-full">
              ...
              {consumptionRef && (
                <Link href={`/unit-head/consumption/${consumptionRef}`} className="block w-full">
                  <Button variant="ghost" className="w-full gap-2">
